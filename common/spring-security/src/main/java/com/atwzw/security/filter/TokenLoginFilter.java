...
import com.atwzw.security.entity.User;
...
/**
 * 登录认证过滤器，继承 UsernamePasswordAuthenticationFilter 类对用户名密码进行登录校验
 */
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
        ...
        ResponseUtil.out(res, RestResult.success().data("token", token));
    }
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        ResponseUtil.out(response, RestResult.error().message("登录失败"));
    }
}
